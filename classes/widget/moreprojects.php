 ...
 * Date : 22.09.12
 * Time : 19:19
 * File : moreProjects.php
 * @name moreProjects
 * @packages Wordpress/ThemeFramework/moreProjects
 * @subpackage Widget
 * @category Widget
 ...
 */
class Widget_MoreProjects extends WPWidget
{
  ...
  function __construct()
  {
    $widget_ops = array(
      ...
      'description' => __('Show a slider with a list of projects, added into portfolio Post Type.', self::$meta[WordpressTheme::OPT_WIDGET_TDOMAIN])
    );

    $control_ops = array( 'id_base' => 'more_projects' );
    parent::__construct( 'more_projects', $widget_ops, $control_ops );
  }

  function widget( $args, $instance )
  {
    $portfolio = $this->_plugin->portfolios();
