 ...
 * @name recentPosts
 * @packages Wordpress/ThemeFramework/recentPosts
 * @subpackage
 * @category
 ...
 */
class Widget_RecentPosts extends WPWidget
{
  ...
  function __construct()
  {
    $widget_ops = array(
      ...
      'description' => __('The latest posts, with a preview thumb.', self::$meta[WordpressTheme::OPT_WIDGET_TDOMAIN])
    );

    $control_ops = array( 'id_base' => 'recent-posts' );

    parent::__construct( 'recent-posts', $widget_ops, $control_ops );
  }
  ...
  <p>
    <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', $this->_meta[WordpressTheme::OPT_WIDGET_TDOMAIN] ) ?>:
  ...
  <p>
    <label for="<?php echo $this->get_field_id( 'items' ); ?>"><?php _e( 'Items', $this->_meta[WordpressTheme::OPT_WIDGET_TDOMAIN] ) ?>:
  ...
  <!--
        <p>
            <label for="<?php echo $this->get_field_id( 'more_text' ); ?>"><?php _e( 'More Text', $this->_meta[WordpressTheme::OPT_WIDGET_TDOMAIN] ) ?>:
