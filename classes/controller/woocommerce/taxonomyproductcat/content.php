...
/**
*@name Controller_Woocommerce_Taxonomyproductcat_Content
...
*/
class Controller_Woocommerce_Taxonomyproductcat_Content extends Controller_Manager{
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_taxonomy', 'taxonomy', 'product-cat');
