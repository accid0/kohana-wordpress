...
/**
*@name Controller_Woocommerce_Taxonomyproducttag_Content
...
*/
class Controller_Woocommerce_Taxonomyproducttag_Content extends Controller_Manager{
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_taxonomy', 'taxonomy', 'product-tag');
