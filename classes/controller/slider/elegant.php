...
/**
*@name Controller_Slider_Elegant
...
*/
class Controller_Slider_Elegant extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'slider-elegant';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_slider', 'slider', 'elegant');
