...
*/
class Controller_Slider_Nivo extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'slider-nivo';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_slider', 'slider', 'nivo');
