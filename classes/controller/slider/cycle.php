...
*/
class Controller_Slider_Cycle extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'slider-cycle';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_slider', 'slider', 'cycle');
