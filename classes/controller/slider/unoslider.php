...
/**
*@name Controller_Slider_Unoslider
...
*/
class Controller_Slider_Unoslider extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'slider-unoslider';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_slider', 'slider', 'unoslider');
