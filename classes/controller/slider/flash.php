...
*/
class Controller_Slider_Flash extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'slider-flash';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_slider', 'slider', 'flash');
