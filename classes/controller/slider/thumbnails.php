...
/**
*@name Controller_Slider_Thumbnails
...
*/
class Controller_Slider_Thumbnails extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'slider-thumbnails';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_slider', 'slider', 'thumbnails');
