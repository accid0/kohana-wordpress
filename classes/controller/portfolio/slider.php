...
/**
*@name Controller_Portfolio_Slider
...
*/
class Controller_Portfolio_Slider extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'portfolio-slider';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_portfolio', 'portfolio', 'slider');
