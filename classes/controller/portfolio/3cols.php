...
/**
*@name Controller_Portfolio_3cols
...
*/
class Controller_Portfolio_3cols extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'portfolio-3cols';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_portfolio', 'portfolio', '3cols');
