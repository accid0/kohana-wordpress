...
/**
*@name Controller_Taxonomy_Portfolio
...
*/
class Controller_Taxonomy_Portfolio extends Controller_Manager{

  /**
   * view file for action
   * @var string
   */
  protected $template = 'taxonomy-portfolio';
  ...
  protected function do_action(){
    ...
    do_action('get_template_part_portfolio', 'portfolio', '');
