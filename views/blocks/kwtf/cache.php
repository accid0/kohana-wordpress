...
<div class="rm_section section_effect" id="menu-section">
  <div class="rm_title">
    <h3>
  ...
  <div class="rm_options">
    ...
    <div id="cache_menu_top-option" class="rm_option rm_input rm_on_off">
      ...
      <div class="iphone-check">
        <input class="on_off" type='checkbox' id='cache_menu_top' name="cache_menu_top"
               value="1"  <?php checked($__cache_menu_top, 1);?>/>
      </div>
      <small><?php _e('Select if you want to active or not the cache top menu', $tpl_tdomain)?></small>
      <div class="clearfix"></div>
    </div>
    <!-- option -->
    <div id="cache_menu_top_ttl-option" class="rm_option rm_input slider_control yiw-deps">
      ...
      <div class="ui-slider">
        ...
        <span id="cache_menu_top_ttl-feedback"
              class="feedback"><strong><?php echo $__cache_menu_top_ttl?></strong></span>
      ...
      <small><?php _e('Select the lifetime cache, expressed in hours.', $tpl_tdomain)?></small>
      <div class="clearfix"></div>
    ...
    <div id="cache_menu_main-option" class="rm_option rm_input rm_on_off">
      ...
      <div class="iphone-check">
        <input class="on_off" type='checkbox' id='cache_menu_main' name="cache_menu_main"
               value="1"  <?php checked($__cache_menu_main, 1);?>/>
      </div>
      <small><?php _e('Select if you want to active or not the cache main menu', $tpl_tdomain)?></small>
      <div class="clearfix"></div>
    </div>
    <!-- option -->
    <div id="cache_menu_main_ttl-option" class="rm_option rm_input slider_control yiw-deps">
      ...
      <div class="ui-slider">
        <span class="minCaption">1</span>
        <span class="maxCaption">720</span>
        <span id="cache_menu_main_ttl-feedback"
              class="feedback"><strong><?php echo $__cache_menu_main_ttl?></strong></span>
...
<div class="rm_section section_effect" id="content-section">
<div class="rm_title">
  <h3>
    <img src="<?php echo $uri_theme?>/images/trans.png" class="inactive" alt="">
    <?php echo __('Content', $tpl_tdomain)?>
  </h3>
  <span class="submit"><input type="submit" name="do" value="<?php _e('Update', $tpl_tdomain)?>"/></span>
...
<div class="rm_options">
  ...
  <div id="cache_scripts-option" class="rm_option rm_input rm_on_off">
    ...
    <div class="iphone-check">
      <input class="on_off" type='checkbox' id='cache_scripts' name="cache_scripts"
             value="1"  <?php checked($__cache_scripts, 1);?>/>
    </div>
    <small><?php _e('Select if you want to active or not the cache scripts', $tpl_tdomain)?></small>
    <div class="clearfix"></div>
  </div>
  <!-- option -->
  ...
  <div id="cache_slider-option" class="rm_option rm_input rm_on_off">
    ...
    <div class="iphone-check">
      <input class="on_off" type='checkbox' id='cache_slider' name="cache_slider"
             value="1"  <?php checked($__cache_slider, 1);?>/>
    </div>
    <small><?php _e('Select if you want to active or not the cache sliders', $tpl_tdomain)?></small>
    <div class="clearfix"></div>
  </div>
  <!-- option -->
  ...
  <div id="cache_map-option" class="rm_option rm_input rm_on_off">
    ...
    <div class="iphone-check">
      <input class="on_off" type='checkbox' id='cache_map' name="cache_map"
             value="1"  <?php checked($__cache_map, 1);?>/>
    </div>
    <small><?php _e('Select if you want to active or not the cache maps', $tpl_tdomain)?></small>
    <div class="clearfix"></div>
  </div>
  <!-- option -->
  ...
  <div id="cache_extra_content-option" class="rm_option rm_input rm_on_off">
    ...
    <div class="iphone-check">
      <input class="on_off" type='checkbox' id='cache_extra_content' name="cache_extra_content"
             value="1"  <?php checked($__cache_extra_content, 1);?>/>
    </div>
    <small><?php _e('Select if you want to active or not the cache extra contents', $tpl_tdomain)?></small>
    <div class="clearfix"></div>
  </div>
  <!-- option -->
  <div id="cache_extra_content_ttl-option" class="rm_option rm_input slider_control yiw-deps">
    <label
      for="cache_extra_content_ttl"><strong><?php echo __('Lifetime Extra Contents (h)', $tpl_tdomain)?></strong></label>

    <div class="ui-slider">
      <span class="minCaption">1</span>
      <span class="maxCaption">720</span>
    <span id="cache_extra_content_ttl-feedback"
          class="feedback"><strong><?php echo $__cache_extra_content_ttl?></strong></span>

      <div id="cache_extra_content_ttl"
...
<div class="rm_section section_effect" id="widgets-section">
<div class="rm_title">
  <h3>
    <img src="<?php echo $uri_theme?>/images/trans.png" class="inactive" alt="">
    <?php echo __('Widgets', $tpl_tdomain)?>
  </h3>
  <span class="submit"><input type="submit" name="do" value="<?php _e('Update', $tpl_tdomain)?>"/></span>
...
<div class="rm_options">
<!-- option -->
<div id="cache_widgets-option" class="rm_option rm_input rm_select yiw-deps">
  <label for="cache_widgets"><strong><?php echo __('Widgets', $tpl_tdomain)?></strong></label>
  <select multiple size="15" name="cache_widgets[]" id='cache_widgets'>
    <?php foreach ($options_widgets as $val => $option) : ?>
    <option
      value="<?php echo $val ?>" <?php selected(in_array($val, (array)$__cache_widgets), TRUE) ?>><?php echo $option; ?></option>
    <?php endforeach ?>
  </select>
  <small><?php _e('You can choose more than one widgets for caching their content.', $tpl_tdomain)?></small>
  <div class="clearfix"></div>
  <div class="fade_color"></div>
</div>
<!-- option -->
<div id="cache_widgets_ttl-option" class="rm_option rm_input slider_control yiw-deps">
  <label
    for="cache_widgets_ttl"><strong><?php echo __('Lifetime Chosen Widgets (h)', $tpl_tdomain)?></strong></label>

  <div class="ui-slider">
    <span class="minCaption">1</span>
    <span class="maxCaption">720</span>
    <span id="cache_widgets_ttl-feedback"
          class="feedback"><strong><?php echo $__cache_widgets_ttl?></strong></span>

    <div id="cache_widgets_ttl" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all">
      <input type="hidden" name="cache_widgets_ttl" value="<?php echo $__cache_widgets_ttl?>"/>
    </div>
  </div>
  <script type="text/javascript">
    jQuery(document).ready(function ($) {
      $('#cache_widgets_ttl').each(function (e) {
        var val = <?php echo $__cache_widgets_ttl ? $__cache_widgets_ttl : 1;?>;
        var minValue = 1;
        var maxValue = 720;
        $(this).slider({
          value:val,
          ...
          step:0.25,
          slide:function (event, ui) {
            $('input[name="cache_widgets_ttl"]').val(ui.value);
            $('#cache_widgets_ttl-feedback strong').text(ui.value + '');
          }
        });
      });
    });
...
<div id="cache_topsidebar-option" class="rm_option rm_input rm_on_off">
  ...
  <div class="iphone-check">
    <input class="on_off" type='checkbox' id='cache_topsidebar' name="cache_topsidebar"
           value="1"  <?php checked($__cache_topsidebar, 1);?>/>
  </div>
  <small><?php _e('Select if you want to active or not the cache top sidebar widgets', $tpl_tdomain)?></small>
  <div class="clearfix"></div>
</div>
<!-- option -->
<div id="cache_topsidebar_ttl-option" class="rm_option rm_input slider_control yiw-deps">
  <label
    for="cache_topsidebar_ttl"><strong><?php echo __('Lifetime Top Widgtes Bar (h)', $tpl_tdomain)?></strong></label>

  <div class="ui-slider">
    <span class="minCaption">1</span>
    <span class="maxCaption">720</span>
    <span id="cache_topsidebar_ttl-feedback"
          class="feedback"><strong><?php echo $__cache_topsidebar_ttl?></strong></span>
...
<div id="cache_sidebar-option" class="rm_option rm_input rm_on_off">
  ...
  <div class="iphone-check">
    <input class="on_off" type='checkbox' id='cache_sidebar' name="cache_sidebar"
           value="1"  <?php checked($__cache_sidebar, 1);?>/>
  </div>
  <small><?php _e('Select if you want to active or not the cache main sidebar widgets', $tpl_tdomain)?></small>
  <div class="clearfix"></div>
</div>
<!-- option -->
...
<div id="cache_big_footer-option" class="rm_option rm_input rm_on_off">
  ...
  <div class="iphone-check">
    <input class="on_off" type='checkbox' id='cache_big_footer' name="cache_big_footer"
           value="1"  <?php checked($__cache_big_footer, 1);?>/>
  </div>
  <small><?php _e('Select if you want to active or not the cache footer sidebar widgets', $tpl_tdomain)?></small>
  <div class="clearfix"></div>
</div>
<!-- option -->
<div id="cache_big_footer_ttl-option" class="rm_option rm_input slider_control yiw-deps">
  <label
    for="cache_big_footer_ttl"><strong><?php echo __('Lifetime Footer Widgets (h)', $tpl_tdomain)?></strong></label>

  <div class="ui-slider">
    <span class="minCaption">1</span>
    <span class="maxCaption">720</span>
    <span id="cache_big_footer_ttl-feedback"
          class="feedback"><strong><?php echo $__cache_big_footer_ttl?></strong></span>
