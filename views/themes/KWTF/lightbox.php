...
require_once( 'mtx-safe-wp-load.php' );
...
<?php        
	...
	wp_enqueue_style( 'kwtf-tinymce-insert-tool', $uri_theme .'/css/toggle.css' );
	wp_print_styles( 'colors-admin' );  
	wp_print_styles( 'kwtf-tinymce-insert-tool' );
...
<body id="media-upload">
	...
	<div id="css-mce-form" class="wrap">
	    <div class="fieldset">
			<label class="css-mce-label"><?php _e( 'Choose shortcode', $tpl_tdomain ) ?></label>
			<div class="css-mce-input">
				<?php echo $dropdown_shortcodes; ?>
	...
	jQuery(document).ready(function($){
	   $('#choose-shortcode-trigger').change(function(){
            ...
            $.post( '<?php echo $_SERVER['REQUEST_URI'] ?>', { shortcode_id:val, ajax:1, do:'Add Shortcodes' }, function(html) {
                $('#fields').html(html);                                                     
